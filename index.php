...
<body>
    ...
    <div class="carousel slide" data-ride="carousel" id="carousel-1">
        <div class="carousel-inner" role="listbox">
            <div class="item active"><img src="assets/img/Raw-Entertainment-Nimue.jpg" alt="Slide Image"></div>
            <div class="item"><img src="assets/img/mii.jpg" alt="Slide Image"></div>
            <div class="item"><img src="assets/img/browne.jpg" alt="Slide Image"></div>
        </div>
    ...
    <div>
        <div class="container" id="features">
            <div class="row">
                <div class="col-md-4"><i class="fa fa-heart fi text-center"></i>
                    <h1 class="text-center">Our Passion</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet venenatis quam, sit amet lacinia metus. Nulla non nulla convallis elit ornare porta.l</p>
                </div>
                <div class="col-md-4"><i class="material-icons fi">attach_money</i>
                    <h1 class="text-center">Great Value</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet venenatis quam, sit amet lacinia metus. Nulla non nulla convallis elit ornare porta.l </p>
                </div>
                <div class="col-md-4"><i class="material-icons fi">fast_forward</i>
                    <h1 class="text-center">Quick Treatment</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec sit amet venenatis quam, sit amet lacinia metus. Nulla non nulla convallis elit ornare porta.l </p>
                </div>
            </div>
        </div>
    ...
    <div class="jumbotron" id="about-us">
        ...
        <p>
            <button class="btn btn-default" type="buttom">Get 50% off first order</button>
        </p>
    </div>
    <footer>
        <div class="row">
            <div class="col-md-4 col-sm-6 footer-navigation">
                <h3><a href="#" class="footer-logo">Company </a></h3>
